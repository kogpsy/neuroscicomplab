...
Wir können unsere Unsicherheit mit einer Standardabweichung von ca. 1.0 ausdrücken. Dies bedeutet, dass ca. 95% der Verteilung im Bereich $[-3.6, 3.6]$
...
```{r}
qlogis(c(.025, .975), location = 0, scale = 1.0)
```
...
### Effekte auf der Wahrscheinlichkeitsskala 
