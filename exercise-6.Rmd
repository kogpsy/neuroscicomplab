...
Sie haben für diese Übung 10 Tage Zeit. Laden Sie bitte Ihre Lösung als ZIP File bis **Dienstag, 1. Juni um 00:00 Uhr**, in den Order für Übung 6 auf ILIAS. Das ZIP File sollte sowohl das Rmarkdown File als auch das generierte HTML File enthalten.
...
Vergleichen Sie anhand einer hierarchischen Shift Function die beiden Rotationsbedinungen (separat) bei den Rotationswinkeln 45 Grad, 90 Grad und 180 Grad (135 Grad aus mir unerklärlichen Gründen zu einem Fehler).
