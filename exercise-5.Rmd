...
```{r}
pupilsize <- read_csv("data/df_pupil_complete.csv") %>% 
...
Sie brauchen die beiden zusätzlichen Argumente `iter = 1e4` und `save_pars = save_pars(all = TRUE)`. Mit dem ersteren erhalten Sie 60000 Samples aus dem Posterior, mit zweiterem speichern Sie die Log Likelihood.
