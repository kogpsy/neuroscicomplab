...
```{r}
d1 <- read_csv("data/schizophrenia-wm.csv")
```
...
- Spezifieren Sie zudem ein geignetes Nullmodell.
:::
...
```{r}
d3 <- read_csv("data/mental-rotation.csv")
```
...
:::exercise
- Spezifieren sie nun ein lineares Modell, mit dem Sie den Zusamenhang zwischen Rotationswinkel und RT untersuchen können.

- Spezifieren sie nun ein lineares Modell, mit dem Sie den Zusamenhang zwischen Rotationswinkel und Fehlerrate untersuchen können.
