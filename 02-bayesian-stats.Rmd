...
```{r binomial-graphical-model, fig.cap="Graphical Model für binomialverteilte Daten."}
knitr::include_graphics("images/binomial-graphical-model.png")
```


```{r bernoulli-graphical-model, fig.cap="Graphical Model für bernoulliverteilte Daten."}
...
```{r normal-graphical-model, fig.cap="Graphical Model für normalverteilte Daten."}
