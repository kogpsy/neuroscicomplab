...
:::code
Sie haben für diese Übung eine Woche Zeit. Laden Sie Ihre Lösung als `Rmarkdown` File bis Donnerstag, 11. März, in den Order für Übung 1 auf ILIAS. Falls `Rmarkdown` nicht funkioniert, werden auch Lösungen in Form eines R Skriptes akzeptiert. Nennen Sie Ihr File `Matrikelnummer_Nachname.Rmd` oder `Matrikelnummer_Nachname.R`, z. B. `15-172-874_Nachname.Rmd`.
:::
