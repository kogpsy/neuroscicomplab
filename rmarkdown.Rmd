...
title: "Rmarkdown"
description: |
  Arbeiten mit RStudio Projects und Rmarktext.
author:
  - first_name: "Andrew"
    last_name: "Ellis"
...
Ich empfehle (wie schon in den Statistik Übungen) **immer** in einem RStudio Projekt zu arbeiten. Als Faustregel: jedes Datenanalyseprojekt kriegt ein eigenes RStudio Projekt. Die Vorteil sind:
...
## `r fontawesome::fa(name = "book", fill = "steelblue")` Rmarkdown

Rmarkdown ist eine Erweiterung der Markdown Sprache, welche wiederum eine einfache Markup Sprache ist.
...
```
 ...
 > Dieses Skript wird mit Rmarkdown erstellt. Wenn Sie auf das `Edit` Icon klicken, sehen Sie den Source Code der Seite, auf der Sie sich gerade befinden.
